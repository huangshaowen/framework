...
class Mongo extends DbDriver {
    ...
    public function switchCollection($collection, $db = '', $master = true) {
        ...
        try {
            ...
            throw new Exception('切换当前操作的Db和Collection出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function command($command = array(), $options = array()) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB命令出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function execute($code, $args = array()) {
        ...
        if ($result['ok']) {
            ...
            throw new Exception('执行MongoDB语句出错:' . $result['errmsg'], 500);
        }
    }
    ...
    public function error() {
        ...
        Log::getInstance()->sql($this->error);
        return $this->error;
    }
    ...
    public function insert($data, $options = array(), $replace = false) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB插入数据出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function getMongoNextId($pk) {
        try {
            ...
            throw new Exception('执行MongoDB生成下一条记录ID出错:' . $e->getMessage(), 500);
        }
        $data = $result->getNext();
    ...
    public function update($data, $options) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB更新记录出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function delete($options = array()) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB删除记录出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function clear($options = array()) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB清空记录出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function select($options = array()) {
        ...
        try {
            ...
            throw new Exception('执行MongoDB查找记录出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function count($options = array()) {
        ...
        try {
            ...
            throw new Exception('MongoDB统计记录数出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function group($keys, $initial, $reduce, $options = array()) {
        ...
        try {
            ...
            throw new Exception('MongoDB分组统计记录数出错:' . $e->getMessage(), 500);
        }
    }
    ...
    public function getFields($collection = '') {
        ...
        try {
            ...
            throw new Exception('MongoDB取得数据表的字段信息出错:' . $e->getMessage(), 500);
        }
        if ($result) { // 存在数据则分析字段
            $info = array();
        ...
        foreach ($where as $key => $val) {
            if ('_id' != $key && 0 === strpos($key, '_')) {
                ...
                if (!preg_match('/^[A-Z_\|\&\-.a-z0-9]+$/', trim($key))) {
                    throw new Exception('MongoDB查询字段出错:' . $key, 500);
                }
                $key = trim($key);
                if (strpos($key, '|')) {
                    $array = explode('|', $key);
